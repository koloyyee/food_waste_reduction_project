            ...
            <blockquote class="blockquote mb-0">
                <form class="form-group"
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            type="email" name="name" class="form-control" id="name"
                            value="${item.getName() }">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label"> Product Description </label> <input
                            ...
                            id="quantity" value="${item.getDiscountRate() * 100 }">
                    </div>

                    <div class="mb-3">
                        <p>Is Surplus? <%= item.isSurplus() ? "✅" : "❌" %>
                        </p>
                    </div>
                    <div class=" mb-3">
                        <p>Is Donation? <%= item.isDonation() ? "✅" : "❌" %>
                        </p>
                    </div>
                    <div class="mb-3">
                        <p>Is Available? <%= item.isAvailable() ? "✅" : "❌" %>
                        </p>
                    </div>
