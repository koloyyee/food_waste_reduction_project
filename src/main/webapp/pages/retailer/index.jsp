				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h1 class="modal-title fs-5" id=<%= "for_surplus_" + item.getName()+ "label"%>> Make it a surplus?</h1>
		...
		<td>
			...
			<div class="modal fade" id=<%= "for_donation_" + item.getName()%> tabindex="-1"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h1 class="modal-title fs-5" id=<%="for_donation_" + item.getName() + "label"%>>Donation</h1>
							<button type="button" class="btn-close" data-bs-dismiss="modal"
								aria-label="Close"></button>
						</div>
						<form
