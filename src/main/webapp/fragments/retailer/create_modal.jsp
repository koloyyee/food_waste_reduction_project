  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="create_modal_label">Modal title</h1>
      ...
      <form action="${request.contextPath}/retailers/items/create">
					...
					<div class="mb-3">
						<label for="expiry_date">Expiry Date:</label>
						 <input type="date"
							name="expiryDate" class="form-control" min="1"
							required>
					</div>

					<div class="mb-3">
						<label for="is_surplus" class="form-check-label">Is it a Surplus Item?:</label> 
						<input
												type="checkbox" name="is_surplus" class="form-check-input"
												required>
						</div>
      
					<div class="mb-3">
						<label for="is_donation" class="form-check-label">Is it for Donation?:</label> <input
												type="checkbox" name="is_donation" class="form-check-input"
												required>
						</div>
      </form>
      </div>
